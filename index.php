...
<head>
    ...
    <meta name="description" content="无需奔波，移动端即可查看自己的成绩，使用更加方便！">
    <meta name="author" content="nuoxian">
    <meta name="keywords" content="学生成绩查询,电子成绩单,成绩,学生">
		...
		<div class="loginFrame">
			...
			<div>
				<label>
					...
					<span>考生号/准考证号</span>
					<input style="border-bottom: 1px solid white" maxlength="14" name="stuid" placeholder="填写您的考生号 / 准考证号" type="text">
				</label>
			</div>
			<div>
				<label>
					...
					<span>身份证号后四位</span>
					<input style="border-bottom: 1px solid white" maxlength="4" name="id" placeholder="填写您的身份证号码后四位" type="text">
				</label>
			</div>
			<div class="enterBut">
...
<?php
		...
		if($link) {
			$result = mysqli_query($link,"select * from $SQLtable where stuid = '$stuid_api'");
		...
		echo "<div class=\"main\">\n";
		echo "<div class=\"loginFrame\">\n";
		echo "	<p>成绩查询结果(<svg t=\"1625342449766\" class=\"iconget\" viewBox=\"0 0 1024 1024\" version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\" p-id=\"1977\" width=\"30\" height=\"30\"><path d=\"M512 76.8c-236.8 0-435.2 192-435.2 435.2s192 435.2 435.2 435.2 435.2-192 435.2-435.2S748.8 76.8 512 76.8z m249.6 320L480 704c-12.8 12.8-38.4 12.8-51.2 0L288 556.8c-12.8-12.8-12.8-38.4 0-51.2 12.8-12.8 38.4-12.8 51.2 0l115.2 115.2L704 339.2c12.8-12.8 38.4-12.8 51.2 0 25.6 12.8 25.6 38.4 6.4 57.6z\" fill=\"#68D279\" p-id=\"1978\"></path><path d=\"M710.4 339.2l-256 281.6-115.2-115.2c-12.8-12.8-38.4-12.8-51.2 0-12.8 12.8-12.8 38.4 0 51.2l147.2 140.8c12.8 12.8 38.4 12.8 51.2 0L768 390.4c12.8-12.8 12.8-38.4 0-51.2-19.2-12.8-44.8-12.8-57.6 0z\" fill=\"#FFFFFF\" p-id=\"1979\"></path></svg>)</p>\n";
